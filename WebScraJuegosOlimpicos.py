...
print("#------------------------------------------------------------------------------#")
print("Debe definir el periodo que desea consultar de los resultados de juegos olímpico")
print("Todos los juegos desde 1896 hasta 2008")
print("")
print("Ingrese el año de inicio de consulta:")
AnnoInicio=int(input())
print("Ingrese el año de fin de consulta:")
AnnoFin=int(input())
...
print("#------------------------------------------------------------------------------#")
print ("Generado archivo maestro de juegos olímpicos registrados...")
print("...")
#Current directory where is located the script
CurrentDir = os.path.dirname(__file__)
FileName = str( AnnoInicio) + "_" + str(AnnoFin) + "_Olympic_Games.csv"
...
print("Archivo generado en el siguiente directorio:" + FilePath)
print("")
...
print("#------------------------------------------------------------------------------#")
print ("Generado archivo detalle de ganadores de medallas...")
